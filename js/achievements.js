...
const ACHIEVEMENT_DEFS = [
    ...
    {
        id: 'first_artist',
        name: '🎤 Premier Artiste Signé',
        description: 'Recrute un artiste talentueux dans ton écurie.',
        icon: '🎤',
        reward: 1000,
        check: () => GameState.artists && GameState.artists.signed && GameState.artists.signed.length >= 1,
    },
    {
        id: 'full_label',
        name: '🌟 Écurie Complète',
        description: 'Signe au moins 4 artistes simultanés sous ton label.',
        icon: '🌟',
        reward: 20000,
        check: () => GameState.artists && GameState.artists.signed && GameState.artists.signed.length >= 4,
    },
    {
        id: 'golden_vinyl',
