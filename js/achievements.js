...
const ACHIEVEMENT_DEFS = [
    ...
    },
    {
        id: 'first_album',
        name: '💿 Dans les Bacs !',
        description: 'Sors ton tout premier album ou single.',
        icon: '💿',
        reward: 1000,
        check: () => GameState.stats.albumsReleased >= 1,
    },
    {
        id: 'five_albums',
        name: '🌟 Discographie d\'Or',
        description: 'Publie 5 albums ou singles.',
        icon: '🌟',
        reward: 20000,
        check: () => GameState.stats.albumsReleased >= 5,
    },
    {
        id: 'golden_vinyl',
    ...
    {
        id: 'first_contract',
        name: '📋 Premier Contrat Signé',
        description: 'Complète ton premier contrat de commande.',
        icon: '📋',
        reward: 500,
        check: () => GameState.stats.contractsCompleted >= 1,
    },
    {
        id: 'all_contracts',
        name: '👑 Légende de l\'Industrie',
        description: 'Complète tous les contrats disponibles.',
        icon: '👑',
        reward: 250000,
        check: () => GameState.stats.contractsCompleted >= CONTRACT_DEFS.length,
    },
    {
        id: 'first_prestige',
