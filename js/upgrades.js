...
const UPGRADE_DEFS = [
    ...
    },
    {
        ...
        category: 'Production',
        description: 'Double les royalties générées par les albums et singles sortis.',
        cost: 25000,
        icon: '💿',
        unlocked: () => GameState.resources.fame >= 25,
        effect: { royaltiesMult: 2.0 },
    },
    {
        id: 'tube_preamp',
    ...
    },
    {
        ...
        category: 'Marketing',
        description: '+100% de renommée ⭐ gagnée sur toutes les actions et contrats.',
        cost: 250000,
        icon: '🤖',
        unlocked: () => GameState.stats.contractsCompleted >= 3,
        effect: { fameMult: 2.0 },
    },
    {
        id: 'energy_storage',
    ...
    {
        id: 'mastering_ai',
        name: '🧠 IA de Mastering Auto-Tune',
        category: 'Technologie',
        description: 'La durée du bonus de Mastering EQ est doublée (120s au lieu de 60s).',
        cost: 10000000,
        icon: '🧠',
        unlocked: () => GameState.resources.fame >= 500,
        effect: { masteringDurationMult: 2.0 },
    },
    {
        id: 'platinum_club',
        name: '💎 Club Privé des Producteurs Diamant',
        category: 'Business',
        description: 'Réduit tous les coûts d\'équipements et de contrats de -20%.',
        cost: 50000000,
        icon: '💎',
